...
namespace MRL
{
    ...
    class DaqCommon
    {
        RtObjectMap _objects; // the runtime objects
        SerialPacketMap _serials; // serial packet drivers
        RtFrameWindowMap _topWindows; // top level windows
        RtWindowMap _tabWindows; // the tab window in the GUI
    public:
        /*!
         * \brief DaqCommon
         */
