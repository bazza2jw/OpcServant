...
void wxCrafteranM2fBInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/InputViewUI_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Common_Gui_InputViewUI_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/InputViewUI_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Common_Gui_InputViewUI_bitmaps.xrc"));
}
