    ...
    class Message {
        ...
        public:
            ...
            */
             ...
             * \brief source
             */
            unsigned source() const { return _source; } // where the message comes from
            /*!
             * \brief destination
             */
            unsigned destination() const { return _destination;} // where it is to go to

            void setSource(unsigned i) { _source = i;}
            void setDestination(unsigned i) { _destination = i;}
            //
