 ...
 */
#ifndef INTERPRETEROBJECTMANAGER_H
#define INTERPRETEROBJECTMANAGER_H
#include "interpreter_global.h"
#include <Common/objectmanager.h>
namespace MRL {
    class InterpreterObjectManager : public ObjectManager {

            public:
                InterpreterObjectManager(const std::string &);
                //
...
#endif // INTERPRETEROBJECTMANAGER_H
