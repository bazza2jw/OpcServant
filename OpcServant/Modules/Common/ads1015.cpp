...
void Adafruit_ADS1015::writeRegister(uint8_t i2cAddress, uint8_t reg, uint16_t value)
{
    ...
    m_i2c->writeBlock(i2cAddress, cmd, 3);
}
...
uint16_t Adafruit_ADS1015::readRegister(uint8_t i2cAddress, uint8_t reg)
{
    ...
    m_i2c->writeBlock(i2cAddress, data, 1);
    m_i2c->readBlock(i2cAddress, data, 2);
...
*/
/**************************************************************************/
Adafruit_ADS1015::Adafruit_ADS1015(MRL::I2cInterfaceBase *i2c, uint8_t i2cAddress)
{
...
*/
/**************************************************************************/
Adafruit_ADS1115::Adafruit_ADS1115(MRL::I2cInterfaceBase * i2c, uint8_t i2cAddress)
{
