...
protected:
    ...
    uint8_t   m_bitShift;
    adsGain_t m_gain;
    MRL::I2cInterfaceBase *      m_i2c;


public:
    Adafruit_ADS1015(MRL::I2cInterfaceBase * i2c = 0, uint8_t i2cAddress = ADS1015_ADDRESS); // set i2c adress = 0 to allow ADS1115 to use this as default constructor
    ...
    void setI2c(MRL::I2cInterfaceBase *i) {m_i2c = i;}
...
{
public:
    Adafruit_ADS1115(MRL::I2cInterfaceBase * i2c, uint8_t i2cAddress = ADS1015_ADDRESS);
