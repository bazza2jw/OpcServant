...
#include <VisualScriptEngine/NUIE_NodeUIManager.hpp>
#include <VisualScriptEngine/NUIE_NodeMenuCommands.hpp>
#include <VisualScriptEngine/BI_BasicUINode.hpp>
#include <VisualScriptEngine/BI_BuiltInFeatures.hpp>
