 ...
 */
#ifndef VisualCalcTYPEOBJECT_H
#define VisualCalcTYPEOBJECT_H
#include <open62541cpp/serverobjecttype.h>
namespace MRL
{
/*!
     * \brief The VisualCalcTypeObject class
     */
    class VisualCalcTypeObject : public Open62541::ServerObjectType
    {
    public:
        VisualCalcTypeObject(Open62541::Server &s, const std::string &n)
