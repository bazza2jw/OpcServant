...
void wxCrafterydm7r3InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/OPCN3UI_opcn3_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Modules_OPCN3_OPCN3UI_opcn3_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/OPCN3UI_opcn3_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Modules_OPCN3_OPCN3UI_opcn3_bitmaps.xrc"));
}
