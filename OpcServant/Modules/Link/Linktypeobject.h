 ...
 */
#ifndef LinkTYPEOBJECT_H
#define LinkTYPEOBJECT_H
...
/*!
     ...
     */
    class LinkTypeObject : public Open62541::ServerObjectType
    {
    public:
        LinkTypeObject(Open62541::Server &s, const std::string &n)
