 ...
 */
#ifndef LinkWEBSETUPDIALOG_H
#define LinkWEBSETUPDIALOG_H
...
namespace MRL {
/*!
     * \brief The LinkWebSetupDialog class
     */
    class LinkWebSetupDialog   : public WebDialogBase {
            PropertyPath _path;
        ...
        public:
            LinkWebSetupDialog(const PropertyPath &path) : _path(path) {}
            void setup();
            void onOk();
