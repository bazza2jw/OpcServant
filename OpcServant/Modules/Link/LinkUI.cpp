...
LinkSetupDialogBase::LinkSetupDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style)
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    SetName(wxT("LinkSetupDialogBase"));
    SetSize(wxDLG_UNIT(this, wxSize(300,400)));
    if (GetSizer()) {
         GetSizer()->Fit(this);
    }
    if(GetParent()) {
...
#endif
    // Connect events
    m_button11->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LinkSetupDialogBase::OnOk), NULL, this);
    
}

LinkSetupDialogBase::~LinkSetupDialogBase()
{
    m_button11->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LinkSetupDialogBase::OnOk), NULL, this);
