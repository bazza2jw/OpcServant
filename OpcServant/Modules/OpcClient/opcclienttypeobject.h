#ifndef OPCCLIENTTYPEOBJECT_H
#define OPCCLIENTTYPEOBJECT_H
#include <open62541cpp/serverobjecttype.h>

namespace MRL
{
/*!
     * \brief The LinkTypeObject class
     */
    class OpcClientTypeObject : public Open62541::ServerObjectType
    {
    public:
        OpcClientTypeObject(Open62541::Server &s, const std::string &n)
