 ...
 */
#ifndef I2CADCTYPEOBJECT_H
#define I2CADCTYPEOBJECT_H
#include <open62541cpp/serverobjecttype.h>
namespace MRL
{
/*!
     * \brief The I2CADCTypeObject class
     */
    class I2CADCTypeObject : public Open62541::ServerObjectType
    {
    public:
        I2CADCTypeObject(Open62541::Server &s, const std::string &n)
