 ...
 */
#ifndef I2CADCOBJECTMANAGER_H
#define I2CADCOBJECTMANAGER_H
#include <Common/objectmanager.h>

namespace MRL
{
/*!
     * \brief The I2CADCObjectManager class
     */
    class I2CADCObjectManager : public ObjectManager
    {
    public:
        I2CADCObjectManager();
        //
