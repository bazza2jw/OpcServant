...
/*!
 * \brief MRL::I2CADCTypeObject::addChildren
 * \param parent
 * \return
 */
bool MRL::I2CADCTypeObject::addChildren(Open62541::NodeId &parent)
{
    Open62541::NodeId n;
    // values
    n.notNull();
...
/*!
 * \brief MRL::I2CADCTypeObject::addInstance
 * \param n
 * \param parent
 * \param nodeId
 * \param requestNodeId
 ...
 * \return
 */
bool MRL::I2CADCTypeObject::addInstance(const std::string &n,
