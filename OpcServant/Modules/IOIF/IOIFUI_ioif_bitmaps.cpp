...
void wxCrafterTsCVPcInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/IOIFUI_ioif_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Modules_IOIF_IOIFUI_ioif_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/IOIFUI_ioif_bitmaps.cpp$_Development_Projects_MRL_OpcServant_OpcServant_Modules_IOIF_IOIFUI_ioif_bitmaps.xrc"));
}
