...
namespace MRL {
    ...
    */
    class MRLLIBSHARED_EXPORT  StatisticsBase {
    ...
    */
    class MRLLIBSHARED_EXPORT Statistics {
            ...
            wxDateTime lowerControlTriggerTime = wxDateTime::Now();
            wxDateTime upperControlTriggerTime = wxDateTime::Now();
            //
            // SPC events
        ...
        public:
            ...
            */
            virtual bool toJson(Json::Value &v) {
                ...
                //
                v["TrackSpc"] = trackSpc;
                v["UpperControl"] = upperControl;
                v["LowerControl"] = lowerControl;
                //
                v["TrendCount"] = trendCount;
                v["MeanCrowding"] = meanCrowding;
                v["TriggerCount"] = triggerCount;

                v["DirTrendUp"] = dirTrendUp;
                v["DirTrendDown"] = dirTrendDown;
                //
                v["UpdateTime"] =  updateTime.FormatISOTime().ToStdString();
                v["UpperControlEnabled"] = upperControlEnabled;
                v["LowerControlEnabled"] = lowerControlEnabled;
                v["LowerControlTrigger"] = lowerControlTriggerTime.FormatISOTime().ToStdString();
                v["UpperControlTrigger"] = upperControlTriggerTime.FormatISOTime().ToStdString();
                //
                // SPC events
                v["TriggerCountExceeded"] = _triggerCountExceeded;
                v["MeanCrowdingExceeded"] = _meanCrowdingExceeded;
                v["TrendCountExceeded"] = _trendCountExceeded;
                //
                v["TriggerCountEnabled"] = _triggerCountEnabled;
                v["MeanCrowdingEnabled"] = _meanCrowdingEnabled;
                v["TrendCountEnabled"] = _trendCountEnabled;

                //
                v["TriggerCountLimit"] = _triggerCountLimit;
                v["MeanCrowdingLimit"] = _meanCrowdingLimit;
            ...
            virtual bool fromJson(Json::Value &v) {
                ...
                numberSamples = v["NumberSamples"].asInt();
                sum = v["Sum"].asDouble();
                sumSquares = v["SumSquares"].asDouble();
                minimum = v["Minimum"].asDouble();
                maximum = v["Maximum"].asDouble();
                //
                // SPC metrics
                //
                trackSpc = v["TrackSpc"].asBool();
                upperControl = v["UpperControl"].asDouble();
                lowerControl = v["LowerControl"].asDouble();
                //
                trendCount = v["TrendCount"].asInt();
                meanCrowding = v["MeanCrowding"].asInt();
                triggerCount = v["TriggerCount"].asInt();

                dirTrendUp = v["DirTrendUp"].asBool();
                dirTrendDown = v["DirTrendDown"].asBool();
                //
                updateTime.ParseISOCombined(v["UpdateTime"].asString());
                upperControlEnabled = v["UpperControlEnabled"].asBool();
                lowerControlEnabled = v["LowerControlEnabled"].asBool();
                lowerControlTriggerTime.ParseISOCombined(v["LowerControlTrigger"].asString());
                upperControlTriggerTime.ParseISOCombined(v["UpperControlTrigger"].asString());
                //
                // SPC events
                _triggerCountExceeded = v["TriggerCountExceeded"].asBool() ;
                _meanCrowdingExceeded = v["MeanCrowdingExceeded"].asBool() ;
                _trendCountExceeded = v["TrendCountExceeded"].asBool() ;
                //
                _triggerCountEnabled = v["TriggerCountEnabled"].asBool() ;
                _meanCrowdingEnabled = v["MeanCrowdingEnabled"].asBool() ;
                _trendCountEnabled = v["TrendCountEnabled"].asBool() ;
                //
                _triggerCountLimit = v["TriggerCountLimit"].asInt();
                _meanCrowdingLimit = v["MeanCrowdingLimit"].asInt();
                _trendCountLimit = v["TrendCountLimit"].asInt();
                return true;
            }
            ...
            */
            ...
            /**
                ...
                @return QDateTime
            */
            wxDateTime getUpdateTime() const {
                return updateTime;
            }
            /**
                ...
                @return QDateTime
            */
            wxDateTime getUpperControlTriggerTime() const {
            ...
            /**
                ...
                @return QDateTime
            */
            wxDateTime getLowerControlTriggerTime() const {
    ...
    */
    class  MRLLIBSHARED_EXPORT StatisticsThreshold {
            double _threshold = 0;
            int    _triggerCount = 0;
            bool   _enabled = false;
            bool   _triggered = false;
            wxDateTime _triggerTime;
        public:
            ...
            */
            ...
            virtual bool toJson(Json::Value &v) {
                ...
                v["triggerCount"] = _triggerCount;
                v["Enabled"] = _enabled;
                v["TriggerTime"] = _triggerTime.FormatISOCombined().ToStdString();
                return true;
            }

            virtual bool fromJson(Json::Value &v) {
                clear();
                Json::Value &t = v["Threshold"];
                _threshold = t.asDouble();
                Json::Value &e = v["Enabled"];
                _enabled =   e.asBool();
                return true;
            }
    ...
    */
    class MRLLIBSHARED_EXPORT StatisticsThresholdSet : public Statistics {
        ...
        public:
            ...
            */
            virtual bool toJson(Json::Value &v) {
                if (Statistics::toJson(v)) {
                    v["Triggered"] =  _triggered; // any of thresholds triggered after setValue
                    v["HiHiLoLo"] = _hihilolo; // hihi or lolo triggered
                    v["HiLoLoHi"] = _hilolohi; // hilo or lohi triggered
                    //
                    // SPC events
                    v["TriggerCountExceeded"] =  _triggerCountExceeded;
                    v["MeanCrowdingExceeded"] = _meanCrowdingExceeded;
                    ...
                    //
                    Json::Value hh;
                    _thresholds[StatisticsThreshold::HiHi].toJson(hh);
                    Json::Value hl;
                    _thresholds[StatisticsThreshold::HiLo].toJson(hl);
                    Json::Value lh;
                    _thresholds[StatisticsThreshold::LoHi].toJson(lh);
                    Json::Value ll;
                    _thresholds[StatisticsThreshold::LoLo].toJson(ll);
                    //
                    v["HiHi"] = hh;
                    v["HiLo"] = hl;
                    v["LoHi"] = lh;
            ...
            */
            bool fromJson(Json::Value &v) {
                clear();
                if (Statistics::fromJson(v)) {
                    _triggered = v["Triggered"].asBool(); // any of thresholds triggered after setValue
                    _hihilolo = v["HiHiLoLo"].asBool(); // hihi or lolo triggered
                    _hilolohi = v["HiLoLoHi"].asBool(); // hilo or lohi triggered
                    //
                    // SPC events
                    _triggerCountExceeded = v["TriggerCountExceeded"].asBool();
                    _meanCrowdingExceeded = v["MeanCrowdingExceeded"].asBool();
                    ...
                    _trendCountLimit = v["TrendCountLimit"].asInt();
                    //
                    Json::Value &hh = v["HiHi"];
                    Json::Value &hl = v["HiLo"];
                    Json::Value &lh = v["LoHi"];
                    Json::Value &ll = v["LoLo"];
                    //
                    _thresholds[StatisticsThreshold::HiHi].fromJson(hh);
                    _thresholds[StatisticsThreshold::HiHi].fromJson(hl);
                    _thresholds[StatisticsThreshold::HiHi].fromJson(lh);
                    _thresholds[StatisticsThreshold::HiHi].fromJson(ll);
                }
                return true;
            }
            ...
            std::string stateToString() {
                switch (maxState()) {
                    ...
                    case StatisticsThreshold::HiLo:
                        return std::string("HiLo");
                    case StatisticsThreshold::LoHi:
                        return std::string("LoHi");
                    case StatisticsThreshold::LoLo:
                        return std::string("LoLo");
                    default:
                        break;
                }
