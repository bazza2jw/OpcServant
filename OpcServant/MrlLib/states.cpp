...
/*!
 * \brief STATES::States::toName
 * \param state
 * \return
 */
std::string STATES::States::toName(unsigned state)
{
    ...
    case STATES::States::StateHiHi: {
        st = _("HiHi").ToStdString();
    }
    break;

    case STATES::States::StateHiLo: {
        st = _("HiLo").ToStdString();
    }
    break;
    case STATES::States::StateLoHi: {
        st = _("LoHi").ToStdString();
    }
    break;
    case STATES::States::StateLoLo: {
        st = _("LoLo").ToStdString();
    }
    break;
