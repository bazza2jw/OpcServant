...
kwxAngularRegulator::kwxAngularRegulator(wxWindow* parent, const wxWindowID id,
                                         int value, int min, int max, const wxPoint& pos,
                                         const wxSize& size, const long int style)
{
    ...
    SetValue(value);
    this->Connect(wxEVT_PAINT, wxPaintEventHandler(kwxAngularRegulator::OnPaint), NULL, this);
    this->Connect(wxEVT_ENTER_WINDOW, wxMouseEventHandler(kwxAngularRegulator::OnMouse), NULL, this);
    this->Connect(wxEVT_LEAVE_WINDOW, wxMouseEventHandler(kwxAngularRegulator::OnMouse), NULL, this);
    this->Connect(wxEVT_LEFT_UP, wxMouseEventHandler(kwxAngularRegulator::OnMouse), NULL, this);
    this->Connect(wxEVT_LEFT_DOWN, wxMouseEventHandler(kwxAngularRegulator::OnMouse), NULL, this);
}


kwxAngularRegulator::kwxAngularRegulator(wxWindow* parent, const wxWindowID id,
                                         const wxPoint& pos, const wxSize& size, const long int style)
{
	Create(parent, id, pos, size, style);
    this->Connect(wxEVT_PAINT, wxPaintEventHandler(kwxAngularRegulator::OnPaint), NULL, this);
    this->Connect(wxEVT_ENTER_WINDOW, wxMouseEventHandler(kwxAngularRegulator::OnMouse), NULL, this);
...
bool kwxAngularRegulator::Create(wxWindow* parent, const wxWindowID id, const wxPoint& pos, const wxSize& size, const long int style)
{
    ...
    // cannot be certain the size if final on create
    m_nClientWidth = 128 ;
    m_nClientHeight = 128 ;
