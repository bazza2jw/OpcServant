...
void wxCrafterY8Mp03InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/NodeEditor_nodeeditor_bitmaps.cpp$_Development_Projects_MRL_NodeFlow_NodeEditor_NodeEditor_nodeeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/NodeEditor_nodeeditor_bitmaps.cpp$_Development_Projects_MRL_NodeFlow_NodeEditor_NodeEditor_nodeeditor_bitmaps.xrc"));
}
